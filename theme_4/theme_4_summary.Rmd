...
\includegraphics[width = 0.7\textwidth]{./images/Serengeti.jpg}

## Tree growth (Packer et al. Science 2005)

\includegraphics[width = 0.8\textwidth]{./images/Treegrowth.jpg}

## The players: Trees

\includegraphics[width = 0.7\textwidth]{./images/trees.jpg}

## The players: Elephants

\includegraphics[width = 0.7\textwidth]{./images/elephant.jpg}
...
\includegraphics[width = 0.9\textwidth]{./images/fire.jpg}

## The players: Wildebeest

\includegraphics[width = 0.9\textwidth]{./images/wilderbeest.jpg}

## The players: A virus?!

\includegraphics[width = 0.6\textwidth]{./images/rinderpest.jpg}

## Interactions at play in the Serengeti

\includegraphics[width = 0.9\textwidth]{./images/chain_sere.jpg}
...
## Lorenzo Camerano: the first food web
\includegraphics[width = 1.5\linewidth]{./images/camerano.jpg}

## Modern food web
\includegraphics[width = 0.6\textwidth]{./images/weddell.jpg}

488 species; 16,200 feeding interactions

## Plant, pollinator, seed disperser network
\includegraphics[width = 0.9\textwidth]{./images/plantpoll.jpg}
...
## Dynamics
```{r echo = FALSE, warning=FALSE, message=FALSE, fig.width=4.5, fig.height=3}
library(ggplot2)
source("code/LV.R")
...
\includegraphics[width = 0.9\textwidth]{./images/case1.jpg}

## Four cases: Case 2 --- sp 2 wins
\includegraphics[width = 0.9\textwidth]{./images/case2.jpg}

## Four cases: Case 3 --- precedence
\includegraphics[width = 0.9\textwidth]{./images/case4.jpg}

## Four cases: Case 4 --- robust coexistence
\includegraphics[width = 0.9\textwidth]{./images/case3.jpg}
...
\includegraphics[width = 0.9\textwidth]{./images/limitcycle_3.jpg}

## 4 Competitors: Chaos

\includegraphics[width = 0.9\textwidth]{./images/chaos_4.jpg}
...
{p'}_{1} {q'}_{1} & {p'}_{1} (1- {q'}_{1}) & (1- {p'}_{1}) {q'}_{1} & (1 - {p'}_{1}) (1- {q'}_{1})\\
{p'}_{2} {q'}_{3} & {p'}_{2} (1- {q'}_{3}) & (1- {p'}_{2}) {q'}_{3} & (1 - {p'}_{2}) (1- {q'}_{3})\\
{p'}_{3} {q'}_{2} & {p'}_{3} (1- {q'}_{2}) & (1- {p'}_{3}) {q'}_{2} & (1 - {p'}_{3}) (1- {q'}_{2})\\
{p'}_{4} {q'}_{4} & {p'}_{4} (1- {q'}_{4}) & (1- {p'}_{4}) {q'}_{4} & (1 - {p'}_{4}) (1- {q'}_{4})
\end{array}
\right)$
...
input <- list(pl1 = "WSLS", pl2 = "TFT", ep = 0.01, k = 0.5)
library(ggplot2)
...
## Average Fitness
```{r, echo=FALSE,message=FALSE,warning=FALSE}
input <- list(pl1_2 = "WSLS", pl2_2 = "TFT", ep = 0.01, k_2 = 0.5)
library(ggplot2)
source("code/MCIPD.R")
...
\includegraphics[width = 0.9\textwidth]{./images/step1.png}
...
\includegraphics[width = 0.9\textwidth]{./images/step5.png}
...
\includegraphics[width = 0.9\textwidth]{./images/spatial1.jpg}

Nowak and May, 1992

## Spatial cooperation $\Pi$

\includegraphics[width = 0.9\textwidth]{./images/spatial2.jpg}
