...
$$\mathbf{M} = \left(\begin{array}{cccc} \mathbf{p'}_{1} \mathbf{q'}_{1} & \mathbf{p'}_{1} (1- \mathbf{q'}_{1}) & (1- \mathbf{p'}_{1}) \mathbf{q'}_{1} & (1 - \mathbf{p'}_{1}) (1- \mathbf{q'}_{1})\\
...
input <- list(pl1 = "WSLS", pl2 = "GRIM", ep = 0.02, k = 0.5)
library(ggplot2)
